...
namespace SIGA.DAO.Seguridad
{
    public class UsuarioDao
    {
        ...
        public int RegistrarUsuario(SIGA.Entities.Seguridad.Usuario objUsuario, List<PerfilUsuario> ListaPerfilUsuario)
        {
        ...
        public int ActualizarUsuario(SIGA.Entities.Seguridad.Usuario objUsuario, List<PerfilUsuario> ListaPerfilUsuario)
        {
            int DocumentoGenerado = 0;
